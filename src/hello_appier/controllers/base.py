...
class BaseController(appier.Controller):
    ...
    def index(self):
        return self.redirect(self.url_for("base.headers"))

    @appier.route("/headers", "GET", json=True)
    def headers(self):
        return self.json(self.request.in_headers, sort_keys=True)
